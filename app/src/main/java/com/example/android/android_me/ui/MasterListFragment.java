...
public class MasterListFragment extends Fragment {
    ...
    //OnImaheClickListener interface, calls a method in the host activity named onImageSelected
    ...
    public void onAttach(Context context) {
        ...
        // This makes sure that the host activity has imlemented the callback interface
